"""
BERT 분류 모델 모듈 - CoLA 태스크용
기존 BERT 모델을 로드하고 분류 헤드를 추가하여 CoLA 태스크에 맞게 조정
"""
...
class BERTForSequenceClassification(nn.Module):
    ...
    def __init__(self, 
        ...
        Args:
            ...
            num_labels: 분류할 레이블 수 (CoLA는 2개: acceptable/unacceptable)
            dropout: 드롭아웃 확률
...
if __name__ == "__main__":
    ...
    try:
        ...
        model = create_classification_model(
            model_path=model_path,
            num_labels=2,  # CoLA: acceptable/unacceptable
            hidden=1024,   # BERT Large
            n_layers=24,   # BERT Large
            attn_heads=16  # BERT Large
        )
